...
To allow connecting other PCs to your PC, simply install `openssh-server` on your PC. Refer [Package Installation](package-installation.md) for help. If this PC is a personal PC, I would also recommend [securing it](https://www.howtogeek.com/443156/the-best-ways-to-secure-your-ssh-server).
